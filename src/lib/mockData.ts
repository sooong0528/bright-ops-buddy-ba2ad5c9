...
export const abnormalRecords: AbnormalRecord[] = [
  {
    id: "abn-001", taskId: "t1", runId: "run-1024", assetId: "as1", assetName: "app-svc-01",
    metric: "CPU 使用率", level: "异常", value: "92%", threshold: ">90% 持续 10 分钟",
    ...
    status: "分析中", analysisTaskId: "an-001",
  },
  {
    id: "abn-002", taskId: "t4", runId: "run-4098", assetId: "as3", assetName: "mq-01",
    metric: "Ping/ICMP", level: "异常", value: "超时", threshold: "连续 3 次失败",
  ...
  {
    id: "abn-003", taskId: "t2", runId: "run-2008", assetId: "as4", assetName: "db-master-01",
    metric: "内存使用率", level: "关注", value: "82%", threshold: "75% ~ 90%",
    time: "2025-04-22 09:03",
    description: "数据库内存使用率升至 82%，接近关注阈值上限。",
    evidenceSnapshot: "近 6 小时内存呈缓慢上升趋势：72% → 82%。",
    status: "分析中", analysisTaskId: "an-003",
  },
  {
    id: "abn-004", taskId: "t1", runId: "run-1024", assetId: "as2", assetName: "app-web-02",
    metric: "CPU 使用率", level: "关注", value: "71%", threshold: "70% ~ 85%",
  ...
  {
    id: "abn-005", taskId: "t3", runId: "run-3005", assetId: "as5", assetName: "db-slave-01",
    metric: "磁盘使用率", level: "关注", value: "68%", threshold: "周环比 >+5%",
